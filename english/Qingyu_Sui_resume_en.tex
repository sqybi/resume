...
\cventry{2010}
        ...
        \footnotetext[1]{\link{http://apex.sjtu.edu.cn/apex\_wiki/yyu}}
\cventry{2012}
        {Popular Science Writer}
        {Guokr\footnotemark[2]{}}
        {}
        {}
        {Write popular science articles\footnotemark[3]{} of Math and Informatics area for Guokr.com.}
...
\cvitem{Algorithm}
       ...
       \footnotetext[4]{http://community.topcoder.com/tc?module=MemberProfile\&cr=22692587}
\cvitem{Language}
       {\textbf{C\#}, \textbf{C++}\newline{}%
