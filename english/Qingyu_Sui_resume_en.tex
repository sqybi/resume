        ...
        {\begin{itemize}%
         ...
         \item Spartan Team, STC.
               ...
               \item Execution Broker for Metadata Platform\newline{}%
                     An orchestration engine which translate data movement in-memory objects to an artifact of Sangam which is a job schedule platform, then deploy and monitor these data movements. This is for Office 365 Big Data Platform and some other internal customers.**************\newline{}%
...
\cventry{2010}
        ...
        {Worked as the teaching assistant of the data structure course in SJTU.\newline{}%
         Responsible for grading, discussion and substitution for instructor\footnotemark[1]{}, etc.}
        \footnotetext[1]{Instructor: Prof. Yu (\link{http://apex.sjtu.edu.cn/apex\_wiki/yyu})}
\cventry{2012}
...
\cvitem{Algorithm}
       ...
       \footnotetext[4]{\link{http://community.topcoder.com/tc?module=MemberProfile\&cr=22692587}}
\cvitem{Language}
       {\textbf{C\#}, \textbf{C++}\newline{}%
