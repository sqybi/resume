...
% personal data
\name{Qingyu}{Sui}
\address{\#401, Zhichundongli, Zhichun Road, Haidian District}{Beijing}{China} % optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
