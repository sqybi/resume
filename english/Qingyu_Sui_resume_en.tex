...
\cventry{2015 -- 2016}
        ...
        {\begin{itemize}%
         \item Mesa Team, DIA.
               ...
               \end{itemize}
         \end{itemize}}
         \footnotetext[1]{Mesa: Geo-replicated, near real-time, scalable data warehousing, \textit{Proceedings of the VLDB Endowment}}
\cventry{2013 -- 2015}
...
\cventry{2013}
        ...
        \footnotetext[2]{How Hierarchical Topics Evolve in Large Text Corpora, \textit{IEEE InfoVis 2014}}
\cventry{2012}
        {SDE Intern}
        {SQL Dev Group, STB}
        {Microsoft}
...
\cventry{2012}
        ...
        \footnotetext[3]{\link{http://www.guokr.com/}}
        \footnotetext[4]{\link{http://www.guokr.com/i/0492216944/articles/}}
\cventry{2011}
        {Developer}
...
\cventry{2010}
        ...
        \footnotetext[5]{Instructor: Prof. Yu (\link{http://apex.sjtu.edu.cn/apex\_wiki/yyu})}
...
\cvitem{Algorithm}
       ...
       \footnotetext[6]{\link{http://community.topcoder.com/tc?module=MemberProfile\&cr=22692587}}
\cvitem{Language}
       {\textbf{C\#}, \textbf{C++}.\newline{}%
